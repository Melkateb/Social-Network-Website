...
<html>
    ...
    <body>
        ...
        function can_sent_request_to($user_email) {
            ...
            $sql = "select email , fname , lname from user where email NOT IN ( SELECT friend_email from friends WHERE email = '$user_email' ) AND email <> '$user_email' AND email NOT IN (SELECT email from f_requests where f_request_email ='$user_email')";
